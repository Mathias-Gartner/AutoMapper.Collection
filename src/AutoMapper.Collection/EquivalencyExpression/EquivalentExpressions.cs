...
namespace AutoMapper.EquivalencyExpression
{
    ...
    {
        public static void AddCollectionMappers(this IMapperConfigurationExpression cfg, Expression<Action<object>> removedObjectCallback = null)
        {
            ...
            cfg.InsertBefore<ReadOnlyCollectionMapper>(
                ...
                new EquivalentExpressionAddRemoveCollectionMapper(removedObjectCallback));
        }
